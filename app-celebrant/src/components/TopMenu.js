      ...
      <Container fluid='md'>
        <div>
          ...
          <div className='icons-container'>
            ...
            <a href='https://twitter.com/amyvhawthorn/' className='social-link'>
          ...
          <Nav className='ms-auto'>
            {loggedIn && (
              <NavDropdown title='ADMIN' id='admin-nav-dropdown'>
                <NavDropdown.Item onClick={() => onAdminClick('/admin/news')}>
                  News
                </NavDropdown.Item>
                <NavDropdown.Item onClick={() => onAdminClick('/admin/gigs')}>
                  Live
                </NavDropdown.Item>
                <NavDropdown.Item onClick={() => onAdminClick('/admin/videos')}>
                  Videos
                </NavDropdown.Item>
                <NavDropdown.Divider />
            ...
            {isHomePage && (
              <>
                ...
                <Nav.Link as={ScrollTo} selector='#about'>
                  ABOUT
                </Nav.Link>
                <Nav.Link as={ScrollTo} selector='#contact'>
                  CONTACT
                </Nav.Link>
              </>
            )}
